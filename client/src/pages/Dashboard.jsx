      ...
      <div className="dashboard-page">
        <div className="dashboard-container">
          <div className="empty-state">
            ...
            <p>
              Calculate your CIBIL score to see your credit profile dashboard
              and get personalized recommendations.
            </p>
            <button
              className="action-btn btn-primary"
              onClick={() => navigate("/cibil-calculator")}
            >
      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-hero">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Your AI-powered credit analysis dashboard
            </p>
            <div className="hero-info">
              <div className="info-item">
                <span className="info-label">📊 Dashboard Function:</span>
                <p>
                  Real-time view of your credit profile, score trends, and
                  personalized financial recommendations based on AI analysis.
                </p>
              </div>
              <div className="quick-actions">
                ...
                <button
                  className="action-btn btn-secondary"
                  onClick={() => navigate("/improve-score")}
                >
                  🚀 Improve Score
                </button>
              </div>
            ...
            <div className="stat-item">
              ...
              <div className="progress-bar">
                <div
                  ...
                  style={{
                    width: `${dashboardData?.user?.profileCompletionPercentage}%`,
                  }}
                ></div>
              </div>
              <span className="stat-value">
                {dashboardData?.user?.profileCompletionPercentage || 100}%
              </span>
            </div>
            <InfoModal
          ...
          <div className="profile-completion-banner">
            <div className="banner-content">
              ...
              <div className="banner-text">
                ...
                <p>
                  Finish setting up your profile to unlock personalized credit
          ...
          <div className="section-header">
            <div className="header-content">
              ...
              <p className="section-subtitle">
                Key factors impacting your creditworthiness
              </p>
            </div>
            <InfoModal
                ...
                <div key={index} className="factor-card">
                  ...
                  <div className="factor-percentage">
                    <div className="percentage-circle">
                      <span className="percentage-value">
                        {Math.round(factor.score ?? factor.percentage ?? 0)}%
                      </span>
                    </div>
                  </div>
                  <div className="factor-bar">
                    <div
                      ...
                      style={{
                        width: `${Math.min(factor.score ?? factor.percentage ?? 0, 100)}%`,
                      }}
                    />
                  </div>
                  <p className="factor-weight">Weight: {factor.weight ?? 0}%</p>
                  <p className="factor-insight">
          ...
          <div className="dashboard-section recommendations-section">
            <div className="section-header">
              <div className="header-content">
                ...
                <p className="section-subtitle">
                  Personalized actions to improve your credit
                </p>
              </div>
              <InfoModal
            ...
            <div className="recommendations-list">
              {dashboardData?.aiRecommendations?.map((rec, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`recommendation-card priority-${priorityClass}`}
                  >
        ...
        <div className="dashboard-section loans-section">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Personalized loan products based on your credit profile
            </p>
          </div>
          <div className="loans-grid">
            {dashboardData?.loanSuggestions?.map((loan, index) => (
              <LoanSuggestionCard key={loan.id || index} loan={loan} />
            ))}
          </div>
        </div>
            ...
            <div className="health-score-card">
              <div className="health-circle">
                <span className="health-score">
                  {dashboardData?.accountHealth?.score}
                </span>
                <span className="health-label">/ 100</span>
              </div>
              <p className="health-status">
                Status: <strong>{dashboardData?.accountHealth?.status}</strong>
              </p>
              <p className="health-updated">
                Last Updated:{" "}
                {new Date(
                  dashboardData?.accountHealth?.lastUpdated,
                ).toLocaleDateString()}
              </p>
            </div>
            <div className="health-assessments">
              {dashboardData?.accountHealth?.assessments?.map(
                (assessment, index) => (
            ...
            {dashboardData?.recentTransactions?.map((transaction, index) => (
              <div key={transaction.id || index} className="transaction-item">
                ...
                <div className="transaction-details">
                  ...
                  <span
                    className={`transaction-status status-${(transaction.status || "unknown").toLowerCase().replace(/\s+/g, "-")}`}
                  >
